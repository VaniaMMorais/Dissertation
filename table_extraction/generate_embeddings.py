...
def process_chunk_list(chunk_list, model):
    ...
    texts = []
    for c in chunk_list:
        # A GRANDE MAGIA DO CONTEXTO:
        if "section" in c:
            # É um texto normal (corpo da tese/artigo). Juntamos o Título ao Texto!
...
def main():
    ...
    print("\n🎉 Processo concluído! O motor semântico leu e interpretou todas as tuas tabelas e textos.")
